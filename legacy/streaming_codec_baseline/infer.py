...
def build_model(ckpt: Dict, dev: torch.device) -> StreamingSVSModel:
    ...
    model = StreamingSVSModel(
        ...
        control_conv_kernel_size=cfg.get("control_conv_kernel_size", 7),
        control_conv_dilation=cfg.get("control_conv_dilation", 1),
        prefix_pad_steps=cfg.get("ablation_prefix_pad_steps", 0),
